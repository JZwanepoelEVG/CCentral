  ...
  (
    ...
    return (
        ...
        <span
            ...
            aria-current={ariaCurrent ?? undefined} // Ensure null is converted to undefined
            data-state={dataState ?? undefined} // Handle null or undefined properly
            data-disabled={dataDisabled ?? undefined} // Ensure null is converted to undefined
            onClick={handleClick}
            {...props}
            >
